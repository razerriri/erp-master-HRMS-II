                            ...
                            <div class="portlet-body">
                                ...
                                <div id="sample_editable_1_wrapper" class="">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Course Name</th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Course Category</th>
                                        ...
                                        <tbody>
                                         <c:forEach var="c" items="${courselist}">
                                            <tr role="row" class="odd">
                                                ...
                                                <td align="center">
                                                    <a class="btn btn-md btn-info" onClick="window.location = 'course/view/'+${c.course_id};"><span class="glyphicon glyphicon-search"></span> View</a>                                              
                                          	    </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
