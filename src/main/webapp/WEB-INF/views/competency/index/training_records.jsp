                            ...
                            <div class="portlet-body">
                                ...
                                <div id="sample_editable_1_wrapper" class="">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Training Title</th>
                                               	<th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Training Description</th>                                               
                                        ...
                                        <tbody>
                                         <c:forEach var="c" items="${traininglist}">
                                            <tr role="row" class="odd">
                                                <td>${c.training_name}</td>
                                                <td>${c.training_desc}</td>
												<td>${c.total_competency}</td>
                                                <td align="center">
                                                    <a class="btn btn-md btn-info" onClick="window.location = 'training/view/'+${c.training_id};"><span class="glyphicon glyphicon-search"></span> View</a>                                              
                                          	    </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
